...
def parse_opts():
    ...
    arguments = {
        ...
        'paths': [
            ...
            dict(name='--root_path',
                 default="/home/leessu/code/CTEN/tools/annotations/caer",
                 type=str,
                 help='Global path of root directory'),
            dict(name="--video_path",
                 default="/home/leessu/dataset/CAER/CAER_frames",
                 type=str,
                 help='Local path of videos', ),
            dict(name="--annotation_path",
                 default='/home/leessu/code/VAANet/tools/annotations/ve8/ve8_03.json',
                 type=str,
            ...
            dict(name='--saliency_path',
                 default="/home/leessu/dataset/CAER/CAER_Saliency",
                 type=str,
            ...
            dict(name='--audio_path',
                 type=str,
                 default='/home/leessu/dataset/CAER/CAER_mp3',
