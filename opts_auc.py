    ...
    arguments = {
        ...
        'paths': [
            ...
            dict(name='--checkpoint_path',
                    ...
                    default='./tools/annotations/ve8/results/result_20251016_111438/checkpoints/save_53_best-acc10.4858.pth',
                 type=str,
            ...
            dict(name="--annotation_path",
                 default='/home/leessu/code/VAANet/tools/annotations/ve8/ve8_01.json',
                 type=str,
