...
from core.model import generate_model,generate_visual_Erase_model, generate_vaaerase_model, generate_vaaerase_saliency_binary_model
...
def main():
    ...
    model, parameters = generate_vaaerase_saliency_binary_model(opt)
