    ...
    arguments = {
        ...
        'paths': [
            ...
            dict(name='--checkpoint_path',
                    #  default='/home/leessu/code/VAANet/tools/annotations/ve8/results/result_20251129_022650/checkpoints/save_48_0.0.4888.pth',
                    # default='/home/leessu/code/VAANet/tools/annotations/ve8/results/result_20251127_200401/checkpoints/save_36_0.5056.pth',
                    default='./tools/annotations/ve8/results/result_20260217_220311/checkpoints/save_11_best-acc10.5199.pth',
                 type=str,
                 help='Path of the saved model checkpoint (.pth)'),
            dict(name='--root_path',
                 default="/home/leessu/code/CTEN/tools/annotations/ve8",
                 type=str,
            ...
            dict(
                name='--test_jobs',
                nargs='*', #옵션을 여러 개 받을 수 있다는 의미
                default=None,
                type=str,
                help='annotation::checkpoint::role 형식의 평가 job 목록. role은 acc 또는 f1'
            ),
        ],
        'core': [
